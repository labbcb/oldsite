...
$$
\begin{aligned}
E(X) &= \int_{-\infty}^{\infty} \!\! x f(x) dx =  \int_0^{1/2} \! 4x^2dx +  \int_{1/2}^{1} \! 4x(1-x)dx\\ 
...
$$
\begin{aligned}
\mbox{Var}(X)& = \int_{-\infty}^{\infty} \!\! (x-E(X))^2 f(x) dx \\
...
> Concluimos então que o tempo médio de vida, $E(X)$, é igual a $1/0.0013863 = 721.3475$ horas, e que $75\%$ dos componentes duram 1000 horas ou menos.
