...
[Vídeo: Chaves e as Estatísticas](https://www.youtube.com/watch?v=VC1NmtmF4zE)
...
[Vídeo: Dilma se enrola com as contas!](https://www.youtube.com/watch?v=A1K4rlBFT2w)
...
ggplot(data=data.frame(notas=notas), aes(notas)) + 
    geom_histogram(binwidth = 10, closed="right", center=65, colour="black", fill="blue") +
