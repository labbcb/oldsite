...
## Exemplo: Vendedor {.build}
Seja $V_1$: venda na primeira visita e $V_2$: venda na segunda visita.
...
> $$
\begin{aligned}
P(X=0) = & P(V_1^c \cap V_2^c) \\
\overset{ind}{=} & P(V_1^c) P(V_2^c) \\ 
= & [1-P(V_1)] [1-P(V_2)] \\  
= & (1-0.3)(1-0.6)=0.28
\end{aligned}
$$
...
$N$ | 0 | 1 | 2
--|:--:|:--:|:--:
$P(N=n)$ | $\displaystyle P\left(XX\right)=\frac{1}{4}$ | $\displaystyle P\left(CX \cup XC\right)=\frac{2}{4}=\frac{1}{2}$ | $\displaystyle P\left(CC\right)=\frac{1}{4}$
...
Suponha que o empresário faça a seguinte pergunta: *Qual o lucro médio por conjunto montado que espero conseguir?* 
